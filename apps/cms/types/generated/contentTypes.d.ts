...
export interface ApiProcedureCategoryProcedureCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'procedure_categories';
  info: {
    description: 'Fa\u021Ba, S\u00E2nul, Silueta, Alte proceduri';
    displayName: 'Procedure Category';
    pluralName: 'procedure-categories';
    singularName: 'procedure-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::procedure-category.procedure-category'
    > &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global contact details, logo, and social links';
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Dr. Sorin T\u0103tulescu'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::procedure-category.procedure-category': ApiProcedureCategoryProcedureCategory;
